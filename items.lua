...
io.writefile('../csv/data/weaponBaseTypes.lua', serializeTable(Weapon.baseTypes))
io.writefile('../csv/data/weaponModifiers.lua', serializeTable(Weapon.modifiers))
io.writefile('../csv/data/weaponModifierFields.lua', serializeTable{Weapon.modifierFields})
io.writefile('../csv/data/defenseModifiers.lua', serializeTable(defenseModifiers))
io.writefile('../csv/data/armorBaseTypes.lua', serializeTable(Armor.baseTypes))
io.writefile('../csv/data/armorModifierFields.lua', serializeTable{Armor.modifierFields})
io.writefile('../csv/data/helmetBaseTypes.lua', serializeTable(Helmet.baseTypes))
io.writefile('../csv/data/helmetModifierFields.lua', serializeTable{Helmet.modifierFields})
io.writefile('../csv/data/shieldBaseTypes.lua', serializeTable(Shield.baseTypes))
io.writefile('../csv/data/shieldModifierFields.lua', serializeTable{Shield.modifierFields})
os.exit()
--]]
