...
path'../csv/data/weaponBaseTypes.lua':write(serializeTable(Weapon.baseTypes))
path'../csv/data/weaponModifiers.lua':write(serializeTable(Weapon.modifiers))
path'../csv/data/weaponModifierFields.lua':write(serializeTable{Weapon.modifierFields})
path'../csv/data/defenseModifiers.lua':write(serializeTable(defenseModifiers))
path'../csv/data/armorBaseTypes.lua':write(serializeTable(Armor.baseTypes))
path'../csv/data/armorModifierFields.lua':write(serializeTable{Armor.modifierFields})
path'../csv/data/helmetBaseTypes.lua':write(serializeTable(Helmet.baseTypes))
path'../csv/data/helmetModifierFields.lua':write(serializeTable{Helmet.modifierFields})
path'../csv/data/shieldBaseTypes.lua':write(serializeTable(Shield.baseTypes))
path'../csv/data/shieldModifierFields.lua':write(serializeTable{Shield.modifierFields})
os.exit()
--]]
